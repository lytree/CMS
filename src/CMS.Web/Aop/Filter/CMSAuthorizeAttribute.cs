...
using CMS.Web.Data.Authorization;
...
namespace CMS.Web.Aop.Filter
{
	...
	public class CMSAuthorizeAttribute : Attribute, IAsyncAuthorizationFilter
	{
		public string Permission { get; }
		public string Module { get; }

		public CMSAuthorizeAttribute(string permission, string module)
		{
