...
namespace CMS.Web.Controllers.v1;
...
public class TestController : ControllerBase
{
	...
	public UnifyResponseDto TestCMSException()
	{
		throw new CMSException("我报异常了-NotFound！", ErrorCode.NotFound, StatusCodes.Status404NotFound);
